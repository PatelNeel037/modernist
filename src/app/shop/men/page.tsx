        ...
        <main className="min-h-screen bg-white">
            ...
            <div className="pt-32 pb-12 text-center bg-gray-50">
                <div className="container mx-auto px-6">
                    <h1 className="text-4xl md:text-5xl font-playfair font-bold text-gray-900 mb-4">Men's Collection</h1>
                    <p className="text-gray-500 max-w-2xl mx-auto">Refined styles for the modern man. From casual weekends to formal events, find your perfect look.</p>
                </div>
            </div>
