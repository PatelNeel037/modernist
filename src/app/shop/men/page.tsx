        ...
        <main className="min-h-screen bg-white">
            ...
            <div className="relative pt-40 pb-20 text-center overflow-hidden mb-12 flex items-center justify-center min-h-[45vh]">
                <div className="absolute inset-0 z-0">
                    <img src="https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?q=80&w=2000&auto=format&fit=crop" alt="Men's Collection" className="w-full h-full object-cover scale-105" />
                ...
                <div className="relative z-10 container mx-auto px-6 inline-block mt-10">
                    <div className="backdrop-blur-xl bg-white/10 border border-white/20 p-12 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] max-w-3xl mx-auto">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-playfair font-bold text-white mb-6 drop-shadow-lg">Men's Collection</h1>
                        <p className="text-gray-100 max-w-2xl mx-auto text-lg md:text-xl drop-shadow font-medium tracking-wide leading-relaxed">Refined styles for the modern man. From casual weekends to formal events, find your perfect look.</p>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-start">
                    ...
                    <aside className="hidden lg:block w-64 sticky top-24 shrink-0 space-y-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {['Cotton', 'Linen', 'Wool', 'Denim'].map(fabric => (
