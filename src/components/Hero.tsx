        ...
        <section className="relative h-screen flex items-center justify-center bg-gray-50 overflow-hidden">
            ...
            <div className="relative z-20 text-center text-white px-4 max-w-4xl mx-auto">
                ...
                <motion.a
                    ...
                    className="inline-block bg-brand-primary text-bg-main hover:bg-brand-dark hover:text-white px-10 py-4 rounded-full text-base font-bold transition-colors shadow-xl border border-transparent hover:shadow-2xl tracking-wide uppercase"
                >
                    SHOP NOW
                </motion.a>
            </div>
